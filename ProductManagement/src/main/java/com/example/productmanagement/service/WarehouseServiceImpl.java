...
public class WarehouseServiceImpl implements WarehouseService{
    ...
    public ApiResponse create(WareHouseDto wareHouseDto){
        ...
        ProvinceEntity productEntity = provinceService.checkId(wareHouseDto.getProvince().getId());
        DistrictEntity districtEntity = districtService.checkId(wareHouseDto.getDistrict().getId());
        ...
        return ApiResponse.builder().status(true).message("Thanh Cong")
